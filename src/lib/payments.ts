...
export const STRIPE_PLANS: Array<{ key: StripePlanKey; name: string; price: number; sessionsCount: number; summary: string }> = [
  { key: 'trial_run', name: 'Trial Run', price: 70, sessionsCount: 2, summary: '2 starter sessions' },
  { key: 'package_1', name: 'Package 1', price: 110, sessionsCount: 3, summary: '3 runs within one month' },
  { key: 'package_2', name: 'Package 2', price: 200, sessionsCount: 6, summary: '6 runs within one month' },
  { key: 'single_run', name: 'Single Run', price: 35, sessionsCount: 1, summary: '1 extra session' },
];
